...
public class TraceState {
	 ...
	 */
	public TraceState(CircuitBoard startingBoard, int row, int col) throws OccupiedPositionException {
	 ...
	 */
	public TraceState(TraceState previousState, int row, int col) throws OccupiedPositionException {
